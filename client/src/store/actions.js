...
export default {
  ...
  async boards_col_detail(context, payload) {
    return await Vue.axios.get(
      `/api/planner/${payload.planner}/boards/${payload.col}`
    );
  },
  ...
  async boards_move(context, payload) {
    return await Vue.axios.post(
      `/api/planner/${payload.planner}/boards/move`,
      payload.data
    );
  },
  ...
  async note_destroy(context, payload) {
    return await Vue.axios.delete(
      `/api/planner/${payload.planner}/boards/${payload.col}/${payload.note}`
    );
  },
  ...
  async note_move(context, payload) {
    return await Vue.axios.post(
      `/api/planner/${payload.planner}/boards/notes/move`,
      payload.data
    );
  },
  //-----------------------
